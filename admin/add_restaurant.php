...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $sql = "INSERT INTO restaurants (name, description, image, address, phone, email, website, rating, price_range, category, cuisine, opening_hours, booking_url, latitude, longitude, specialties, features, tags, is_active) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        $stmt->execute([
            $_POST['name'],
            $_POST['description'],
            $_POST['image'] ?: 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=800',
            $_POST['address'],
            $_POST['phone'],
            $_POST['email'] ?: null,
            $_POST['website'] ?: null,
            ...
            $_POST['category'] ?: 'Restaurant',
            $_POST['cuisine'] ?: 'Française',
            $_POST['opening_hours'] ?: 'Lun-Dim: 12h-14h, 19h-22h',
...
<head>
    ...
    <title>Ajouter un Restaurant - Guide d'Agen</title>
    <style>
    ...
    <div class="container">
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description" placeholder="Décrivez le restaurant..."></textarea>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="email" name="email" placeholder="contact@restaurant.fr">
                </div>
            </div>
            
            <div class="form-group">
                <label for="website">Site web</label>
                <input type="url" id="website" name="website" placeholder="https://www.restaurant.fr">
            </div>
            
            <div class="form-group">
                <label for="opening_hours">Horaires d'ouverture</label>
                <input type="text" id="opening_hours" name="opening_hours" value="Lun-Dim: 12h-14h, 19h-22h">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="specialties" name="specialties" placeholder="Magret aux pruneaux, Foie gras, Cassoulet">
                <div class="form-help">Séparez par des virgules</div>
            </div>
            
            <div class="form-group">
                <label for="tags">Tags</label>
                <input type="text" id="tags" name="tags" placeholder="Local, Traditionnel, Terrasse">
                <div class="form-help">Séparez par des virgules</div>
            </div>
            
            <h3 style="margin: 2rem 0 1rem 0; color: #1f2937;">🍽️ Informations de réservation</h3>
            
            <div class="form-row">
                <div class="form-group">
                    <label for="booking_platform">Plateforme de réservation</label>
                    <input type="text" id="booking_platform" name="booking_platform" placeholder="LaFourchette, OpenTable...">
                </div>
            ...
            <div class="form-group">
                ...
                <input type="url" id="booking_url" name="booking_url" placeholder="https://www.lafourchette.com/restaurant/...">
            </div>
